...
-- }}}
tags[1][1].name = "1.Chromium"
tags[1][2].name = "2.Ternimal"
tags[1][3].name = "3.FileManager"
tags[1][4].name = "4.Matlab"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "g", function () awful.layout.inc(layouts, -1) end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "g",      awful.client.floating.toggle                     ),
